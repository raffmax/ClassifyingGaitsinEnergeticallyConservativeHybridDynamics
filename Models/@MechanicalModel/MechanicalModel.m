classdef (Abstract) MechanicalModel < matlab.mixin.Copyable
    ...
    methods (Abstract) %% - must be implemented by the subclasses -
        ...
        [conEvent,eventData] = getEventFunctional(obj,t,x,z,T,iEvent,controller, Grad1, Grad2, epsFix)
    end
    ...
    methods
        ...
        %% --- Flow Map ---
        [f, lambda, fGrad, lambdaGrad] = FlowMap(obj, t, x, z, T, controller, Grad1, Grad2, epsFix)
        %% --- Jump Map ---
